defmodule Mazes.RectangularMazeTest do
  ...
  describe "adjacent_vertices" do
    ...
    test "when no walls" do
      ...
      assert RectangularMaze.adjacent_vertices(maze, {1, 1}) == [{2, 1}, {1, 2}]
      assert RectangularMaze.adjacent_vertices(maze, {2, 2}) == [{2, 1}, {1, 2}, {3, 2}, {2, 3}]
      assert RectangularMaze.adjacent_vertices(maze, {3, 3}) == [{3, 2}, {2, 3}]
    end
  end
